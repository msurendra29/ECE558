 ...
 * Edited by Richa and Surendra on 11/25/2016.
 */

/**
 * SignUp Activity allows you to make a valid database entry by signing with a username, password and home location (latitude and longitude)
 */
public class SignUPActivity extends LoginActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        editTextConfirmPassword = (EditText)findViewById(R.id.signup_confirm_password);
        ...
        latitude = (EditText)findViewById(R.id.signup_latitude);
        longitude = (EditText)findViewById(R.id.signup_longitude);
