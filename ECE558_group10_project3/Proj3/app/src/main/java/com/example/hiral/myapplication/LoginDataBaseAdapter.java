...
/**
 * In this the database is created to save the user provided information while siging up for the first time and
 * the same information is fetched when the user sign in the next time he logs in.
 */
